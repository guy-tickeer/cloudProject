...
class FilteredNewsByDate extends StatelessWidget {
  final DateTime date;

  FilteredNewsByDate(this.date);

  @override
  Widget build(BuildContext context) {
    var newsList = Provider.of<News>(context).news.where((article) {
      String dateToSearch = DateFormat('yyyy-MM-dd').format(date);
      return article.date.contains(dateToSearch);
    }).toList();
    return Scaffold(
